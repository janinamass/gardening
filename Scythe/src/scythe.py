...
def runScythe(groups, delim, asID, namesList, cleanUp, stopAfter, faFileList, inDir, outDir, gapOpen, gapExtend):
...
def main():
    ...
    try:
        opts, args = getopt.gnu_getopt(sys.argv[1:], "i:o:s:d:a:g:O:E:mcvhM", 
                                        ["in_dir=","out_dir=",
                                         "stop_after=",
                                         "delim=", "asID=",
